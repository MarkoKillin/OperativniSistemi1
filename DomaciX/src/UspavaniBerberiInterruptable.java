 ...
 */
class BerbernicaSemafor {
    private Semaphore berber = new Semaphore(2);
    private Semaphore musterija = new Semaphore(0);
    public void zauzmiBerbera() throws InterruptedException {
        berber.acquire();
        musterija.release();
    }
    public void oslobodiBerbera() throws InterruptedException {
        berber.release();
        musterija.acquire();
    }
    public void zauzmiMusteriju() throws InterruptedException {
        musterija.acquire();
    }
...
public class UspavaniBerberiInterruptable extends Application {
    private BerbernicaSemafor bs = new BerbernicaSemafor();
    @AutoCreate(2)
