...
class BerbernicaSemafor {
    ...
    private Semaphore musterija = new Semaphore(2);
    public void zauzmiBerbera(){
        berber.acquireUninterruptibly();
    }
    public void oslobodiBerbera(){
        berber.release();
    }
    public void zauzmiMusteriju(){
        musterija.acquireUninterruptibly();
    }
...
public class BerberiSemaforInterruptable extends Application {
